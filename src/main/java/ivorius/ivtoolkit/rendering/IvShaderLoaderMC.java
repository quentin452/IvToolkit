...
public class IvShaderLoaderMC extends IvDependencyLoaderMC {
    ...
    public void setUpShader(IvShaderInstance shaderInstance, ResourceLocation vertexShader,
        ResourceLocation fragmentShader) throws LoadException, RecursionException {
