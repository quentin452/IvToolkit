...
public class CubeMesh {
    ...
    public static void renderSides(Collection<ForgeDirection> sides, double x1, double y1, double z1, double x2,
        double y2, double z2, IIcon icon) {
        for (ForgeDirection direction : sides) renderSide(direction, x1, y1, z1, x2, y2, z2, icon);
    }

    public static void renderSide(ForgeDirection side, double x1, double y1, double z1, double x2, double y2, double z2,
        IIcon icon) {
        switch (side) {
            case NORTH:
