...
public class IvTextureCreatorMC {
    ...
    public static BufferedImage getImage(IResourceManager resourceManager, ResourceLocation location, Logger logger)
        throws IOException {
        ...
        if (textureObject instanceof ThreadDownloadImageData) {
            ...
            for (Object layeredTextureNameObj : ((LayeredTexture) textureObject).layeredTextureNames) {
                ...
                if (layeredTextureName != null) {
                    try (InputStream inputstream = resourceManager.getResource(new ResourceLocation(layeredTextureName))
                        .getInputStream()) {
                        ...
                        if (bufferedimage == null) {
                            bufferedimage = new BufferedImage(
                                ...
                                bufferImageLayer.getHeight(),
                                2);
                        }

                        bufferedimage.getGraphics()
                            .drawImage(bufferImageLayer, 0, 0, null);
                    }
                }
            }
