...
public class IvColorHelper {
    ...
    public static int[] getARBGInts(float[] argb) {
        return new int[] { MathHelper.floor_float(argb[0] * 255.0f + 0.5f),
            MathHelper.floor_float(argb[1] * 255.0f + 0.5f), MathHelper.floor_float(argb[2] * 255.0f + 0.5f),
            MathHelper.floor_float(argb[3] * 255.0f + 0.5f) };
    }

    public static float[] getARBGFloats(int[] argb) {
        return new float[] { (float) argb[0] / 255.0f, (float) argb[1] / 255.0f, (float) argb[2] / 255.0f,
            (float) argb[3] / 255.0f };
    }
    ...
    public static float[] getARBGFloats(int argb) {
        ...
        return new float[] { (float) alpha / 255.0f, (float) red / 255.0f, (float) green / 255.0f,
            (float) blue / 255.0f };
    }
