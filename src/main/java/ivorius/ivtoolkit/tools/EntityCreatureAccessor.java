...
public class EntityCreatureAccessor {
    ...
    protected static Field maximumHomeDistance() {
        return maximumHomeDistance != null ? maximumHomeDistance
            : (maximumHomeDistance = ReflectionHelper
                .findField(EntityCreature.class, "maximumHomeDistance", "field_70772_bD"));
    }
