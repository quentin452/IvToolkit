...
public class IvPathHelper {
    ...
    public static Path resourceToPath(URL resource) throws IOException, URISyntaxException {
        ...
        try {
            ...
            if (fs.isOpen()) return fs.getPath(entryName);
    ...
    public static Path pathFromResourceLocation(ResourceLocation resourceLocation)
        throws URISyntaxException, IOException {
        URL resource = IvPathHelper.class
            .getResource("/assets/" + resourceLocation.getResourceDomain() + "/" + resourceLocation.getResourcePath());
        return resource != null ? resourceToPath(
            resource.toURI()
                .toURL())
            : null;
    }

    public static List<Path> listFilesRecursively(Path dir, final DirectoryStream.Filter<Path> filter,
