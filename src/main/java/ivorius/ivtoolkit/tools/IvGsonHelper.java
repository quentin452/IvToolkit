...
public class IvGsonHelper {
    ...
    public static String serializedName(Enum anEnum) {
        ...
        try {
            SerializedName serializedName = anEnum.getClass()
                .getField(name)
    ...
    public static <E extends Enum> E enumForName(String serializedName, E[] values) {
        for (E anEnum : values) {
            if (serializedName(anEnum).equals(serializedName)) return anEnum;
        }
    ...
    public static <E extends Enum> E enumForNameIgnoreCase(String serializedName, E[] values) {
        for (E anEnum : values) {
            if (IvGsonHelper.serializedName(anEnum)
                .equalsIgnoreCase(serializedName)) return anEnum;
        }
