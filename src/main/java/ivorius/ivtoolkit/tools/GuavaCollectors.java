...
public class GuavaCollectors {
     ...
     * Collect a stream of elements into an {@link ImmutableMap}.
     */
    public static <K, U> Collector<K, ?, ImmutableMultimap<K, U>> toMultimap(
        Function<? super K, Iterable<? extends U>> valueMapper) {
     ...
     * Collect a stream of elements into an {@link ImmutableMap}.
     */
    public static <T, K, U> Collector<T, ?, ImmutableMultimap<K, U>> toMultimap(
        Function<? super T, ? extends K> keyMapper, Function<? super T, Iterable<? extends U>> valueMapper) {
        return Collector.of(
            ImmutableMultimap.Builder<K, U>::new,
