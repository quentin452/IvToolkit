...
public class Animator {
    ...
    public Animator(Animation animation, boolean loop) {
        ...
        for (NodeAnimation nodeAnimation : animation.nodeAnimations) nodeAnimators.add(new NodeAnimator(nodeAnimation));
    ...
    public void update(float time, float alpha) {
        ...
        for (NodeAnimator nodeAnimator : nodeAnimators) nodeAnimator.update(time, alpha);
    }
