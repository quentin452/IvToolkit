...
public class NodeAnimator {
    ...
    public NodeAnimator(NodeAnimation nodeAnimation) {
        ...
        for (NodeKeyframe nodeKeyframe : nodeAnimation.keyframes) {
            ...
            if (nodeKeyframe.scale != null) animatorScale.addKeyframe(nodeKeyframe.scale, nodeKeyframe.keytime);
        ...
        if (animatorScale.keyframeCount() == 0) animatorScale.addKeyframe(nodeAnimation.node.scale, 0.0f);
        if (animatorRotation.keyframeCount() == 0) animatorRotation.addKeyframe(nodeAnimation.node.rotation, 0.0f);
    }
