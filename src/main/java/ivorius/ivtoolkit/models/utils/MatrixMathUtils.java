...
public class MatrixMathUtils {
    ...
    public static Matrix4f setTRS(Matrix4f matrix, float translationX, float translationY, float translationZ,
        float quaternionX, float quaternionY, float quaternionZ, float quaternionW, float scaleX, float scaleY,
        float scaleZ) {
