...
public class AxisAlignedTransform2D {
    ...
    public static AxisAlignedTransform2D transform(AxisAlignedTransform2D original, int rotationClockwise,
        boolean flipX) {
        return flipX ? original.rotateClockwise(rotationClockwise)
            .flipX() : original.rotateClockwise(rotationClockwise);
    }
    ...
    public void rotateBlock(World world, BlockCoord coord, Block block) {
        for (int i = 0; i < rotation; i++) block.rotateBlock(world, coord.x, coord.y, coord.z, ForgeDirection.UP);
    }
    ...
    public String toString() {
        return "AxisAlignedTransform2D{" + "rotation=" + rotation + ", mirrorX=" + mirrorX + '}';
    }
}
