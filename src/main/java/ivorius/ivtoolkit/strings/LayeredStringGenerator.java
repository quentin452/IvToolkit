...
public class LayeredStringGenerator {
    ...
    public static class LayerSimple implements Layer {
        ...
        public void addStrings(int weight, String... strings) {
            for (String s : strings) baseStrings.add(new WeightedSelector.SimpleItem<>(weight, s));
        }
        ...
        public String randomString(Random random) {
            ...
            for (char aChar : component.toCharArray()) {
                ...
                if (subLayer == null) stringBuilder.append(aChar);
                else stringBuilder.append(subLayer.randomString(random));
            }
    ...
    public static class LayerStatic implements Layer {
        ...
        @Deprecated
        public void addStrings(int weight, String... strings) {
            for (String s : strings) baseStrings.add(new WeightedSelector.SimpleItem<String>(weight, s));
        }
