...
public class IvItemRendererModel implements IItemRenderer {
    ...
    public IvItemRendererModel(ItemModelRenderer model, ResourceLocation texture, float modelSize, float[] translation,
        float[] rotation) {
        this.model = model;
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        if (type == ItemRenderType.ENTITY) GL11.glTranslated(0.0, 1.0, 0.0);
        else if (type == ItemRenderType.INVENTORY) GL11.glTranslated(0.0, 0.3, 0.0);
