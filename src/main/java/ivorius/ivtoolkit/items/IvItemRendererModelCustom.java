...
public class IvItemRendererModelCustom implements IItemRenderer {
    ...
    public IvItemRendererModelCustom(ItemModelRenderer model, ResourceLocation texture, float modelSize,
    ...
    public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object... data) {
        ...
        if (type == IItemRenderer.ItemRenderType.ENTITY) GL11.glTranslated(0.0, 1.0, 0.0);
        else if (type == IItemRenderer.ItemRenderType.INVENTORY) GL11.glTranslated(0.0, 0.3, 0.0);
        else GL11.glTranslated(0.5, 1.0, 0.5);
    ...
    public static class ItemModelRendererSimple implements ItemModelRenderer {
        ...
        /**
         * The list of render parts for reference. If null, the model will render all parts, otherwise {@link #additive}
         * will be used.
         */
        ...
        public void render(ItemStack stack) {
            if (renderParts != null) {
                if (additive) model.renderOnly(renderParts);
                else model.renderAllExcept(renderParts);
